...
void CDownloadFile::DownloadFile(wxProgressDialog * dlg, const wxString& outputFile, const wxString& crtFile)
{
	...
	curl_easy_setopt(curl, CURLOPT_URL, CConvertUtility::ConvertToStdString(httpAdress).c_str());
	//curl_easy_setopt(curl, CURLOPT_CAINFO, "./ca-bundle.crt");
	curl_easy_setopt(curl, CURLOPT_CAINFO, CConvertUtility::ConvertToStdString(crtFile).c_str());
