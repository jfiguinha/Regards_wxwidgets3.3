...
Section "RegardsViewer" SecRegardsViewer
  ...
  DetailPrint "*** Installing Regards Viewer 3.14.0..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 3.14.0"
